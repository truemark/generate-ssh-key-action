...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (config.type === 'rsa') {
                (0, execa_1.execaCommandSync)(`ssh-keygen -t rsa -b 4096 -f ${keyPath} -q -N ''`);
            }
            else {
                (0, execa_1.execaCommandSync)(`ssh-keygen -t ed25519 -f ${keyPath} -q -N ''`);
            }
            fs.chmodSync(keyPath, '600');
            fs.chmodSync(pubKeyPath, '644');
            (0, core_1.setOutput)('private-key-path', keyPath);
            (0, core_1.setOutput)('public-key-path', pubKeyPath);
            (0, core_1.setOutput)('public-key', fs.readFileSync(pubKeyPath, 'utf8'));
        }
        catch (error) {
